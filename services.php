...
<html>
  <head>
  <title>Services | FIMAN Trading cc</title>
	<meta charset="utf-8">
...
<h3 style="font-size: 200%;">SERVICES</h3>
</th>
</tr>
<tr>
<td class="featuresfitdiv">
<h2>
                <p> <a href="Clothing.php">Clothing Supplies</a></p> 
				<p> <a href="promotional.php">Promotional items (Branded rulers, Pens, USB, Key holders, Bags, Openers)</a></p>
				<p> <a href="indoor.php">Indoor and Outdoor advertisements (Banners, Signboards & Billboards, Feather flags and Gazebos)</a></p> 
				<p> <a href="signage.php"> Printing & Signs (Signage and Road traffic signs)</a></p> 
				<p> <a href="safety.php"> Safety wear (Overalls, Boots,  safari and Reflectors)</a></p>
				<p> <a href="supplies.php">Supplies and Deliveries of goods </a></p> 
				<p> <a href="office.php">Office/School  furnitures  &  stationaries  supplies</a></p>
				<p> <a href="it.php">Information Technology accessories supplies and installations</a></p>  
				<p> <a href="fabricated.php">Pre-fabricated materials (Offices, Guard rooms and Cold rooms)</a></p>
				<p> <a href="cleaning.php">Cleaning, Clearing and de-bushing services</a></p>
				<p> <a href="Civil.php">Civil constructions (Building and Renovations, Road constructions and all civil works)</a></p>
</h2>
</td>
</tr>
</table>
