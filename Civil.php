...
<html>
  <head>
  <title>Civil constructions | FIMAN Trading cc</title>
	<meta charset="utf-8">
...
<center>
<h1><b>Civil constructions</b></h1>
<p style="font-size:25px;">


Fiman Trading provides general contracting, construction management and <br>pre-engineered metal building services to a

broad range of commercial and industrial clients throughout Namibia.<br>

With a passion for construction, we provide the highest level of service to every client by dedicating our time and energy<br>

to producing only the finest quality of workmanship to enhance the lifestyles of our customers.<br>

We believe in working closely with our client in order to ensure the product we deliver meets<br>

their expectations. We understand the importance of the positive partnering concept and pride ourselves on making<br>

the construction process as stress free as possible for the client.<br>

After the completion of each project we undertake, there must remain a satisfied client who will ask<br>

us back for the next project and recommend us to others. Otherwise,<br>

we have failed in our mission of providing superior construction services.<br>
